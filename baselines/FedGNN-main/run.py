...
path_dataset =  'data/ml-100k/ratings_matrix.mat'
Otraining_path_dataset =  'data/ml-100k/Otraining.mat'
Otest_path_dataset =  'data/ml-100k/Otest.mat'
...
if __name__ == "__main__":
    ...
    Otraining = load_matlab_file(Otraining_path_dataset, 'Otraining')
    Otest = load_matlab_file(Otest_path_dataset, 'Otest')
